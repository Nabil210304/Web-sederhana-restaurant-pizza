...
<section class="contact">
   ...
   <div class="row">
      ...
      <form action="" method="post">
         ...
         <input type="number" name="number" min="0" max="9999999999" class="box" placeholder="masukan nomor anda" required maxlength="10">
         ...
         <input type="submit" value="masukan pesan anda" name="send" class="btn">
      </form>
